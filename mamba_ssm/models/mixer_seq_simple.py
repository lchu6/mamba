...
class MixerModel(nn.Module):
    ...
    def forward(self, input_ids, inference_params=None, **mixer_kwargs):
        ...
        # this applies to non-first stages, where input is a tuple of (hidden_states, residual)
        ...
        # this applies to non-last stages, where we output (hidden_states, residual) directly
        if not self.norm_f:
...
class MambaLMHeadModel(nn.Module, GenerationMixin):
    ...
    def forward(self, input_ids, position_ids=None, inference_params=None, num_last_tokens=0, **mixer_kwargs):
        ...
        # this applies to non-last stages, the hidden_states here is a tuple (hidden_states, residual)
        if not self.lm_head:
            return hidden_states
